...
phone = input("\033[34m введите номер жертвы. +")
def qw(_phone):
    if _phone[0] == '+':
        _phone = _phone[1:]
    if _phone[0] == '8':
...
slowprint("бомбежка началась, все в укрытие!Примерное время бомбежки: 2 минуты.")
...
input("\03[31m + (бомбер завершил работу, нажмите любую кнопку для выхода : ")
#bomber by lkqas)